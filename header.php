...
<div class="karkas">
    <div class="header">
        ...
        <p class="head-contakt">
            <img src="<?php bloginfo('template_url'); ?>/images/head-mail.png" alt="" /> <a href="<?php bloginfo('admin_email'); ?>"><?php bloginfo('admin_email'); ?></a>
            &nbsp;&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;&nbsp;
...
<?php if(!dynamic_sidebar( 'icons_header' )): ?>
            <span style="color:#FFFFFF">Место для иконок соц.сетей</span>
<?php endif; ?>
